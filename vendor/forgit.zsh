...
# add aliases
alias ${forgit_add:-_f_git_add}='forgit::add'
alias ${forgit_log:-_f_git_log}='forgit::log'
alias ${forgit_diff:-_f_git_diff}='forgit::diff'
alias ${forgit_ignore:-_f_git_ignore}='forgit:ignore'
alias ${forgit_restore:-_f_git_restore}='forgit::restore'
